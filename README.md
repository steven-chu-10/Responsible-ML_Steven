...
Libraries Used
LibraryPurposepandasData loading, filtering, and manipulationnumpyNumerical operations and array handlingstatsmodelsLogistic regression (GLM with binomial family)matplotlibBar charts and visualizationsscikit-learnModel pipeline, preprocessing, gradient-boosted tree, evaluation metricslimeLocal interpretable model-agnostic explanationswarningsSuppressing non-critical warnings
...
bashpip install pandas numpy statsmodels matplotlib scikit-learn lime
3. Run the notebook
